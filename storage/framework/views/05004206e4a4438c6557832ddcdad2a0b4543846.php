<?php if(session()->get('notify.model') === 'drake'): ?>
    <div class="notify fixed inset-0 flex items-end justify-center px-4 py-6 pointer-events-none sm:p-6 sm:items-start sm:justify-end">
        <div
            x-data="{ show: <?php if(session()->get('notify.model') === 'drake'): ?> true <?php else: ?> false <?php endif; ?> }"
        ...
        >
            <div class="h-40 relative rounded-md shadow-xs overflow-hidden">
                <?php if(session()->get('notify.type') === 'success'): ?>
                    <img class="absolute inset-0" src="<?php echo e(asset('/vendor/mckenziearts/laravel-notify/images/drake-success.jpg')); ?>" alt="">
                    <div class="bg-green-500 absolute inset-0 opacity-75"></div>
                <?php else: ?>
                    <img class="absolute inset-0" src="<?php echo e(asset('/vendor/mckenziearts/laravel-notify/images/drake-error.jpg')); ?>" alt="">
...
<?php endif; ?>
<?php /**PATH J:\OneDrive\Zeeshan Programming\ZarBooks\vendor\mckenziearts\laravel-notify\src/../resources/views/notifications/drakify.blade.php ENDPATH**/ ?>