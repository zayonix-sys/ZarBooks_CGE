                        ...
                        <table id="dtTrns" class="table table-sm table-striped table-hover border-bottom">
                            ...
                            <?php $__empty_1 = true; $__currentLoopData = $trns; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $trn): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <tr>
                                    ...
                                    <td><?php echo e($trn->description); ?></td>
...
<?php echo $__env->make('layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH I:\OneDrive\Zeeshan Programming\ZarBooks\resources\views/accounts/dashboard.blade.php ENDPATH**/ ?>