        ...
        <script type="text/javascript">
            $(document).ready(function () {
                ...
                data.each(function (value, index) {
                    ...
                    if (index != 0) {
                        isOpBal = dtTrns.cell(index - 1, 6).data().replace(/,/g, '');
                        isDr = dtTrns.cell(index, 4).data().replace(/,/g, '');
                        isCr = dtTrns.cell(index, 5).data().replace(/,/g, '');
                    ...
                    $.get(url, function (trnDetails)
                    {
                        ...
                        for (let i = 0; i < trnDetails.length; i++)
                        {
                            $('#tblShowVoucher tbody').append(
                                ...
                                '<td class="text-center drTrnsAmount">'+thousandSeperator(trnDetails[i].dr_amount)+'</td>' +
                                '<td class="text-center crTrnsAmount">'+thousandSeperator(trnDetails[i].cr_amount)+'</td></tr>'
                            );
                        }
                ...
                function calculateRowSum() {
                    ...
                    $('.drTrnsAmount').each(function () {
                        drSum += parseFloat($(this).text().replace(/,/g, ''));
                    });
                    $('#trnsDr').text(drSum).formatNumber();

                    //Credit Total
                    $('.crTrnsAmount').each(function () {
                        crSum += parseFloat($(this).text().replace(/,/g, ''));
                    });
                ...
                <div class="card-header border-bottom bg-dark">
                    <div class="row align-items-center justify-content-between">
                        <div class="col-6 col-sm-auto d-flex align-items-center pr-0">
                            <h5 class="fs-2 mb-0 text-nowrap py-2 py-xl-0 text-warning font-weight-semi-bold">General Ledger</h5>
                        </div>
                    ...
                    <div class="table-responsive fs--1">
                        <table id="dtTrns" class="table table-striped border">
                            ...
                            <tr>
                                ...
                                <th class="border-0">Trn Date</th>
                                <th class="border-0">P/R</th>
                                <th class="border-0">Particular</th>
                                <th class="border-0">Debit (DR)</th>
                                <th class="border-0">Credit (CR)</th>
                            ...
                            <?php if(isset($openingBal)): ?>
                                <tr>
                                    <td></td>
                                    <td><?php echo e($openingBal['start_date']); ?></td>
                                    <td>-</td>
                                    <td>Opening Balance</td>
                                    <td></td>
                                    <td></td>
                                    <td><?php echo e(number_format($openingBal['ob'])); ?></td>
                                </tr>
                            <?php endif; ?>
                            <?php if(isset($trns)): ?>
                                <?php $__empty_1 = true; $__currentLoopData = $trns; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $trn): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                    <tr>
                                        ...
                                        <td><?php echo e(date('d-M-Y', strtotime($trn->trn_date))); ?></td>
                                        <td>
                                        ...
                                        <td><?php echo e(!empty($trn->dr_amount) ? number_format($trn->dr_amount) : ''); ?></td>
                                        <td><?php echo e(!empty($trn->cr_amount) ? number_format($trn->cr_amount) : ''); ?></td>
                                        <td>0</td>
                                    </tr>
