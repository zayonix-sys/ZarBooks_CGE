<?php $__env->startSection('title', 'Fiscal Year'); ?>
                    ...
                    <div class="table-responsive fs--1">
                        <table id="fyDataTable" class="table table-striped border-bottom">
                            ...
                            <?php $__empty_1 = true; $__currentLoopData = $fiscalYears; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $fiscalYear): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <tr>
                                    <td>
                                        <?php echo e($fiscalYear->fy_title); ?>

                                    </td>
                                    <td>
                                        <?php echo e(date('d-M-Y', strtotime($fiscalYear->fy_start_date))); ?>

                                    </td>
                                    <td>
                                        <?php echo e(date('d-M-Y', strtotime($fiscalYear->fy_end_date))); ?>

                                    </td>
                                    <td class="text-center">
                                        <?php if($fiscalYear->is_active == 1 ): ?>
                                    ...
                                    <span class="badge rounded-capsule badge-soft-success">
                                      <a data-id="<?php echo e($fiscalYear->id); ?>" class="editFY">Edit
...
<?php echo $__env->make('layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH I:\OneDrive\Zeeshan Programming\ZarBooks\resources\views/maintain/fiscalYear.blade.php ENDPATH**/ ?>