...
<?php $__env->startPush('footer'); ?>
	...
	<script type="text/javascript">
		...
		$(document).ready(function(){
			...
			//Credit Column Disabled
			$('#tblTransEntry').on('keyup', 'td:nth-child(3)', function(){
				var dr = $(this).find('.drTrnsAmnt').val();
				if(dr.length > 0)
				{
					$(this).closest('td').next('td').find('input').val('');
					$(this).closest('td').next('td').find('input').attr('disabled', 'disabled');
				}
				else
				{
					$(this).closest('td').next('td').find('input').removeAttr('disabled', 'disabled');
				}
			});
			...
			$('#tblTransEntry').on('keyup', 'td:nth-child(4)', function(){
				...
				if(cr.length > 0)
				{
					...
					$(this).closest('td').prev('td').find('input').attr('disabled', 'disabled');
				}
				else
				{
					$(this).closest('td').prev('td').find('input').removeAttr('disabled', 'disabled');
				}
			});
		});
	...
	<div class="col-md-12">
		<div class="card mb-3">
			...
			<div class="card-body">
				<div class="row">
					<div class="col-lg-8">
						<h3 class="mb-0">Journal Voucher</h3>
								...
								<div class="card-body">
									<div class="table-responsive fs--1">
										<div class="d-flex">
											...
											<button class="btn btn-falcon-default btn-sm rounded-capsule ml-auto my-2 mx-1" type="button" id="btnAddAccount">
												<span class="fas fa-plus mr-1" data-fa-transform="shrink-3"></span>Add Account
											</button>
					                ...
					                <tbody>
					                  	<tr>
						                    ...
						                    <td class="align-left">
						                    	<input class="form-control form-control-sm drTrnsAmnt" name="txtDRAmnt" type="number" placeholder="Enter Amount">
						                    </td>
						                    <td class="align-left">
						                    	<input class="form-control form-control-sm crTrnsAmnt" name="txtCRAmnt" type="number" placeholder="Enter Amount">
						                    </td>
...
<?php echo $__env->make('layout', Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\Projects\ZarBooks\resources\views/accounts/journalVoucher2.blade.php ENDPATH**/ ?>
