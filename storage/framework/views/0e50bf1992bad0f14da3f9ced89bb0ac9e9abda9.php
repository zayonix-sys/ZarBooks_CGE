...
$__env->startSection('title', 'Balance Sheet'); ?>
                        ...
                        <table id="dtBalanceSheet" class="table table-sm border"
                            ...
                            <?php if(isset($accounts)): ?>
                                ...
                                <tr>
                                    ...
                                    <td class="text-right font-weight-bold pr-3 bg-soft-warning">Rs. <?php echo e(number_format($totalAndPeriod['totalOwnerEquity'])); ?></td>
                                </tr>
                                <tr>
                                    <td class="text-right font-weight-bold bg-soft-success">
                                        Total Equities <i class="fas fa-long-arrow-alt-right fs-2 pt-2"></i>
                                    </td>
                                    <td class="text-right font-weight-bold pr-3 bg-soft-success">Rs. <?php echo e(number_format($totalAndPeriod['totalEquities'])); ?>
...
<?php echo $__env->make('layout', Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\Projects\ZarBooks\resources\views/reports/balance-sheet.blade.php ENDPATH**/ ?>
