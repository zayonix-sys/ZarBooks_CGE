<?php if(session()->get('notify.model') === 'emotify'): ?>
    <div class="notify fixed inset-0 flex items-end justify-center px-4 py-6 pointer-events-none sm:p-6 sm:items-start sm:justify-end">
        <div
            x-data="{ show: <?php if(session()->get('notify.model') === 'emotify'): ?> true <?php else: ?> false <?php endif; ?> }"
            x-show="show"
            ...
            class="max-w-sm w-full shadow-lg rounded-lg pointer-events-auto <?php if(session()->get('notify.type') === 'success'): ?> bg-gradient-to-r from-teal-500 via-green-500 to-green-800 <?php endif; ?> <?php if(session()->get('notify.type') === 'error'): ?> bg-gradient-to-r from-orange-500 via-red-500 to-red-800 <?php endif; ?>"
        >
...
<?php endif; ?>
<?php /**PATH I:\OneDrive\Zeeshan Programming\ZarBooks\vendor\mckenziearts\laravel-notify\src/../resources/views/notifications/emotify.blade.php ENDPATH**/ ?>