                    ...
                    <div class="row align-items-center justify-content-between">
                        <div class="col-6 col-sm-auto d-flex align-items-center pr-0">
                            <h5 class="fs-2 mb-0 text-nowrap py-2 py-xl-0 text-warning font-weight-semi-bold">
                                Trail Balance
                                <span
                                    class="text-light fs--1 d-block mt-1">As On <?php echo e(date_format(today(), 'd-M-Y')); ?></span>
                            </h5>
                        </div>
                            ...
                            <?php $__currentLoopData = $accounts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $trialAccount): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    ...
                                    <td class="text-center align-middle">
                                        <a href="#" class="showLedger" data-id="<?php echo e($trialAccount->id); ?>" data-name="<?php echo e($trialAccount->title); ?>">
                                            <?php echo e($trialAccount->code); ?>

                                        </a>
                                    </td>
                                    <td>
                                        <a href="#" class="showLedger" data-id="<?php echo e($trialAccount->id); ?>" data-name="<?php echo e($trialAccount->title); ?>">
                                            <?php echo e($trialAccount->title); ?>

                                        </a>
                                    </td>
                                    <td class="text-right align-middle"><?php echo e(number_format($trialAccount->dr_amount)); ?></td>
                                    <td class="text-right align-middle"><?php echo e(number_format($trialAccount->cr_amount)); ?></td>
                                    <td class="text-right align-middle pr-4"><?php echo e(number_format($trialAccount->balance)); ?></td>
                                </tr>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </tbody>
                            <tfoot class="bg-200">
...
<?php echo $__env->make('layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH I:\OneDrive\Zeeshan Programming\ZarBooks\resources\views/reports/trial-balance-report.blade.php ENDPATH**/ ?>