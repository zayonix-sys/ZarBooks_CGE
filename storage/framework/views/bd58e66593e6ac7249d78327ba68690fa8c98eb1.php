<?php $__env->startSection('title', 'Income Statment'); ?>
                                    ...
                                    <?php if($account->account_group == 50): ?>
                                        ...
                                        <?php $__currentLoopData = $account->account; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cntrlAccount): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <tr>
                                                ...
                                                <td class="text-right pr-5"><?php echo e(number_format($cntrlAccount->balance)); ?></td>
                                            </tr>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    <?php endif; ?>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
...
<?php echo $__env->make('layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH I:\OneDrive\Zeeshan Programming\ZarBooks\resources\views/reports/income-statement.blade.php ENDPATH**/ ?>