<?php $__env->startSection('title', 'Credit Voucher'); ?>
...
<?php $__env->startSection('content'); ?>
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card">
                <div class="card-body">
                    <form action="<?php echo e(route('accounts/crVoucher/store')); ?>" method="POST" id="frmCrEntry">
                        <?php echo csrf_field(); ?>
                        <div class="form-row ">
                            <div class="col-sm-2">
                                <label for="datepicker">Transaction Date</label>
                                <input class="form-control datetimepicker flatpickr-input" id="dpVoucherDate"
                                       type="text"
                                       name="trn_date">
                            </div>
                            <div class="col-sm-3">
                                <label>Received From</label>
                                <input type="text" class="form-control" name="payee" value="<?php echo e(old('payee')); ?>" required autofocus>
                            </div>
                            <div class="col-sm-7">
                                <label>Messer</label>
                                <input type="text" class="form-control" name="messer" value="<?php echo e(old('messer')); ?>" required>
                            </div>
                        </div>
                        <div class="form-row mt-3">
                            <div class="col-sm-2">
                                <label>Select Receipt Account</label>
                                <select class="form-control selectpicker" id="ddParentAccounts" name="receipt_account">
                            ...
                            <div class="col-sm-3">
                                ...
                                <select class="form-control selectpicker" id="ddControllingAccount"
                                        name="debit_account">
...
<?php echo $__env->make('layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\Projects\ZarBooks\resources\views/accounts/creditVoucher.blade.php ENDPATH**/ ?>