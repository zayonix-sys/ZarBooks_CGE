	...
	<div class="col-md-12">
		<div class="card mb-3">
			...
			<div class="card-body">
				<div class="row">
					<div class="col-lg-8">
						<h3 class="mb-0">Credit Voucher</h3>
							...
							<div class="card">
								<div class="card-body">
									<div class="table-responsive fs--1">
										<div class="d-flex">
											<p class="text-warning">- Press Enter On Amount Column to Add More Credit Account or Use Button</p>
											<button class="btn btn-falcon-default btn-sm rounded-capsule ml-auto my-2 mx-1" type="button" id="btnAddAccount">
												<span class="fas fa-plus mr-1" data-fa-transform="shrink-3"></span>Add Credit Account
											</button>
...
<?php echo $__env->make('layout', Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\Projects\ZarBooks\resources\views/accounts\creditVoucher.blade.php ENDPATH**/ ?>
