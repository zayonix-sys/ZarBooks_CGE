                    ...
                    <form action="<?php echo e(route('accounts/drVoucher/store')); ?>" method="POST" id="frmDrEntry">
                        ...
                        <div class="form-row mt-3">
                            <div class="col-sm-2">
                                ...
                                <select class="form-control selectpicker" id="ddParentAccounts" name="payment_account">
...
<?php echo $__env->make('layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\Projects\ZarBooks\resources\views/accounts/debitVoucher.blade.php ENDPATH**/ ?>