...
$__env->startSection('title', 'Edit Item'); ?>
                ...
                $('#ddParentCategory').on('change focus load', function (e) {
                    ...
                    $.get(url, function (subCategories) {
                        ...
                        for (let i = 0; i < subCategories.length; i++) {
                            ...
                            $('#ddSubCategories').val(<?php echo e($item[0]->category->id); ?>);
        ...
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-body fs--1">
                    <form action="/item/update/<?php echo e($item[0]->id); ?>" method="post" enctype="multipart/form-data">
                        <?php echo csrf_field(); ?>
                                        ...
                                        <div class="form-row mt-4">
                                            <div class="col-sm-4">
                                                ...
                                                <select class="form-control selectpicker" id="ddParentCategory"
                                                    ...
                                                    <?php $__currentLoopData = $parentCategories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $parentCategory): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <option
                                                            value="<?php echo e($parentCategory->id); ?>"
                                                            <?php echo e(($parentCategory->id === $item[0]->category->parent_id) ? 'selected' : ''); ?>>
                                                            <?php echo e($parentCategory->title); ?>
                                            ...
                                            <div class="col-sm-2">
                                                ...
                                                <input type="number" name="purchase_price" class="form-control fs--1"
                                                       value="<?php echo e($item[0]->purchase_price); ?>">
                                            </div>
                                            <div class="col-sm-2">
                                                <label>Sale Price</label>
                                                <input type="number" name="sale_price" class="form-control fs--1"
                                                       value="<?php echo e($item[0]->sale_price); ?>">
                                            </div>
                                        </div>
                                        <div class="form-row mt-4">
                                            <div class="col-sm-12">
                                                ...
                                                <textarea class="form-control fs--1" rows="5"
                                                          name="description"><?php echo e($item[0]->description); ?></textarea>
                                            </div>
                                        </div>
                                        <div class="form-row mt-4">
                                            <div class="col-sm-4">
