        ...
        <script type="text/javascript">
            $(document).ready(function () {
                ...
                $('#ddAccountGroup').on('change', function (e) {
                    ...
                    let url = "{{ route('getParentAccounts', ':accGroup') }}";
                ...
                function EditAccount($dataTable)
                {
                    $dataTable.on('click', '.editAccount', function () {
                        ...
                        let url = "{{ route('getControllingAccount', ':accCode') }}";
                            ...
                            <div class="col-sm-3">
                                ...
                                <select class="form-control selectpicker" id="ddParentAccount" name="parent_account_id">
                                    @foreach($assetsAccounts as $assetsAccount)
                                        <option value="{{ $assetsAccount->id }}">{{ $assetsAccount->title }}</option>
									@endforeach
                                </select>
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="tab-content mx-3 my-3" id="v-pills-tabContent">
                        ...
                        <div class="tab-pane fade shadow rounded bg-white show active p-3" id="tbAssets"
                            ...
                            <div class="table-responsive fs--1">
                                <table id="dtAssets" class="table table-sm table-striped border-bottom">
                                    ...
                                    <tbody>
                                    @forelse($controllingAccounts as $controllingAccount)
                                        @if($controllingAccount->parent_accounts->account_group == 10)
                                            <tr>
                                                <td class="align-middle">
                                                    {{ $controllingAccount->code }}
                                                </td>
                                                <td class="align-middle ">
                                                    {{ $controllingAccount->parent_accounts->title }}
                                                </td>
                                                <td class="align-middle ">
                                                    <h6>{{ $controllingAccount->title }}</h6>
                                                </td>
                                                <td class="align-middle ">
                                                    @if ($controllingAccount->status == 1 )
                        ...
                        {{-- Shows Liabilities Accounts --}}
                        <div class="tab-pane fade shadow rounded bg-white show p-3" id="tbLiabilities"
                             role="tabpanel" aria-labelledby="v-pills-home-tab">
                            <div class="table-responsive fs--1">
                                <table id="dtLiabilities" class="table table-sm table-striped border-bottom">
                                    <thead class="bg-200 text-900">
                                    <tr>
                                        <th class="border-0">Code</th>
                                        <th class="border-0 ">Parent Account</th>
                                    ...
                                    <tbody>
                                    @forelse($controllingAccounts as $controllingAccount)
                                        @if($controllingAccount->parent_accounts->account_group == 20)
                                            <tr>
                                                <td class="align-middle">
                                                    {{ $controllingAccount->code }}
                                                </td>
                        ...
                        {{-- Shows Equities Accounts --}}
                        <div class="tab-pane fade shadow rounded bg-white show p-3" id="tbEquities"
                             role="tabpanel" aria-labelledby="v-pills-home-tab">
                            <div class="table-responsive fs--1">
                                <table id="dtEquities" class="table table-sm table-striped border-bottom">
                                    <thead class="bg-200 text-900">
                                    <tr>
                                        <th class="border-0">Code</th>
                                        <th class="border-0 ">Parent Account</th>
                                    ...
                                    <tbody>
                                    @forelse($controllingAccounts as $controllingAccount)
                                        @if($controllingAccount->parent_accounts->account_group == 30)
                                            <tr>
                                                <td class="align-middle">
                                                    {{ $controllingAccount->code }}
                                                </td>
                        ...
                        {{-- Shows Revenues Accounts --}}
                        <div class="tab-pane fade shadow rounded bg-white show p-3" id="tbRevenues"
                             role="tabpanel" aria-labelledby="v-pills-home-tab">
                            <div class="table-responsive fs--1">
                                <table id="dtRevenues" class="table table-sm table-striped border-bottom">
                                    <thead class="bg-200 text-900">
                                    <tr>
                                        <th class="border-0">Code</th>
                                        <th class="border-0 ">Parent Account</th>
                                    ...
                                    <tbody>
                                    @forelse($controllingAccounts as $controllingAccount)
                                        @if($controllingAccount->parent_accounts->account_group == 40)
                                            <tr>
                                                <td class="align-middle">
                                                    {{ $controllingAccount->code }}
                                                </td>
                        ...
                        {{-- Shows Expenses Accounts --}}
                        <div class="tab-pane fade shadow rounded bg-white show p-3" id="tbExpenses"
                             role="tabpanel" aria-labelledby="v-pills-home-tab">
                            <div class="table-responsive fs--1">
                                <table id="dtExpenses" class="table table-sm table-striped border-bottom">
                                    <thead class="bg-200 text-900">
                                    <tr>
                                        <th class="border-0">Code</th>
                                        <th class="border-0 ">Parent Account</th>
                                    ...
                                    <tbody>
                                    @forelse($controllingAccounts as $controllingAccount)
                                        @if($controllingAccount->parent_accounts->account_group == 50)
                                            <tr>
                                                <td class="align-middle">
                                                    {{ $controllingAccount->code }}
                                                </td>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="{{ route('addParentAccount') }}" method="post">
                        @csrf
                        <div class="form-row ">
                            <div class="col-sm-12">
