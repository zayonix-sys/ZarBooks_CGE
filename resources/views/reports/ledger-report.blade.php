...
@section('content')
    ...
    @push('footer')
        ...
        <script type="text/javascript">
            $(document).ready(function () {
                ...
                let ob = {{ isset($openingBal['ob']) ? $openingBal['ob'] : 0 }};
            ...
            <div class="card-deck">
                <div class="card mb-3 overflow-hidden" style="min-width: 12rem">
                    <div class="bg-holder bg-card"
                         style="background-image:url('{{asset('media/illustrations/corner-3.png')}}');"></div>
                    <!--/.bg-holder-->
                ...
                <div class="card mb-3 overflow-hidden" style="min-width: 12rem">
                    <div class="bg-holder bg-card"
                         style="background-image:url('{{asset('media/illustrations/corner-1.png')}}');"></div>
                    <!--/.bg-holder-->
                    <div class="card-body position-relative">
                        <h6>Total Debit</h6>
                ...
                <div class="card mb-3 overflow-hidden" style="min-width: 12rem">
                    <div class="bg-holder bg-card"
                         style="background-image:url('{{asset('media/illustrations/corner-2.png')}}');"></div>
                    <!--/.bg-holder-->
                    <div class="card-body position-relative">
                        <h6>Total Credit</h6>
    ...
    <div class="row">
        <div class="col-md-3">
            <div class="card">
                <div class="card-body">
                    <form action="{{ route('accounts/showLedgerReport') }}" method="POST" id="frmCrEntry">
                        @csrf
                        <div class="form-row">
                        ...
                        <div class="col-6 col-sm-auto d-flex align-items-center pr-0">
                            <h5 class="fs-2 mb-0 text-nowrap py-2 py-xl-0 text-warning font-weight-semi-bold">
                                ...
                                <span class="text-light fs--1 d-block mt-1">For The Period
                                    @isset($openingBal)
                                        {{ $openingBal['from_date'].' ~ '.$openingBal['to_date'] }}
                                    @endisset
                                </span>
                            </h5>
                        </div>
                    ...
                    <div class="table-responsive fs--1">
                        <table id="dtTrns" class="table table-sm table-striped border">
                            ...
                            @isset($openingBal)
                                <tr>
                                    <td></td>
                                    <td class="text-center">{{ $openingBal['from_date']}}</td>
                                    <td>-</td>
                                    <td>Opening Balance</td>
                                    <td></td>
                                    <td></td>
                                    <td class="text-right pr-4">{{ number_format($openingBal['ob']) }}</td>
                                </tr>
                            @endisset
                            @isset($trns)
                                @forelse($trns as $trn)
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            @switch( $trn->status )
                                                @case('Pending')
                                                <a href="#" class="showTrn" data-id="{{$trn->id}}">
                                        ...
                                        <td>{{ $trn->particular }}</td>
                                        <td class="text-center">{{ !empty($trn->dr_amount) ? number_format($trn->dr_amount) : '' }}</td>
                                        <td class="text-center">{{ !empty($trn->cr_amount) ? number_format($trn->cr_amount) : '' }}</td>
                            ...
                            <div class="card-body">
                                <div class="table-responsive fs--1">
                                    <table class="table table-striped border" id="tblShowVoucher">
                                        ...
                                        <tbody>
                                            {{-- Dynamically Display Table Transactions --}}
                                        </tbody>
                                        <tfoot class="bg-200">
                                            <th></th>
                                            <th></th>
